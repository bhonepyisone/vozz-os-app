...
const menuItems = [ { id: 1, name: 'Espresso', price: 2.50 }, { id: 2, name: 'Latte', price: 3.50 }, { id: 3, name: 'Cappuccino', price: 3.50 }, { id: 4, name: 'Croissant', price: 2.75 }, { id: 5, name: 'Muffin', price: 3.00 }, { id: 6, name: 'Tea', price: 2.00 } ];
    ...
    <div className="flex h-[calc(100vh-8rem)]">
      ...
      <div className="w-2/5 bg-white p-6 rounded-lg shadow-md flex flex-col">
        ...
        <div className="flex-grow overflow-y-auto mt-4">
          {cart.length === 0 ? <p className="text-gray-500">No items in order.</p> : cart.map(item => (
        ...
        <div className="border-t pt-4">
          ...
          <button onClick={() => setCart([])} className="w-full bg-green-600 text-white py-3 rounded-lg text-lg font-bold hover:bg-green-700">Charge</button>
        </div>
      </div>
    </div>
  );
